<?php
/**
 * Title: CTAs in Columns
 * Slug: torasen/cta-columns
 * Categories: columns
...
<div class="wp-block-column"><!-- wp:image {"id":1526,"linkDestination":"none"} -->
<figure class="wp-block-image"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/placeholders/770x560.png'); ?>" alt="" class="wp-image-1526"/></figure>
<!-- /wp:image -->
...
<p>Donec consectetur nisl ex, vitae volutpat odio placerat mollis. Proin et elit non ex maximus volutpat ornare vitae diam. Phasellus hendrerit sem quis massa rhoncus, ut consectetur lacus porta.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

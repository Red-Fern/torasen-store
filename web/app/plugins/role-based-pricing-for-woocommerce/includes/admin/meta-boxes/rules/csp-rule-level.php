					...
					foreach ($rcus_base_price as $cus_price) {
						...
						<tr id="filter-row-rule<?php echo intval($post->ID); ?><?php echo intval($a); ?>">
							...
							<td align="center" class="rcname5 rheight">
								<input type="date" min="0" name="rcus_base_price[<?php echo intval($a); ?>][start_date]" value="<?php echo esc_attr($cus_price_start_date); ?>" />
							</td>
							<td align="center" class="rcname6 rheight">
								<input type="date" min="0" name="rcus_base_price[<?php echo intval($a); ?>][end_date]" value="<?php echo esc_attr($cus_price_end_date); ?>" />
							</td>

		...
		<div className="flex flex-col gap-3 w-full pb-4 border-b border-gray-300">
			<div className="flex flex-col gap-3 w-full | md:flex-row">
				...
				<div className="md:w-3/4 flex gap-2">
					...
					>
						<span className="block py-2 px-3">{range}</span>
					</div>
					...
					<button
						...
						onClick={() => openRange()}
					>
						<span className="block py-2 px-3 border-r border-gray-300">{isOpen ? 'Close' : 'Switch'}</span>
						<span className="py-2 px-3">
							{isOpen ? (
								<svg className="w-4 h-4 fill-[#6C6C65]" xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="currentColor">
								...
								<svg className="w-4 h-4 fill-[#6C6C65]" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="currentColor">

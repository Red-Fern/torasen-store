...
class WC_Conditional_Shipping_Payments {
	...
	public function initialize_plugin() {
		...
		if ( ! function_exists( 'phpversion' ) || version_compare( phpversion(), '7.0.0', '<' ) ) {
			...
			$notice = sprintf( __( 'Woo Conditional Shipping and Payments requires at least PHP <strong>%1$s</strong>. Learn <a href="%2$s">how to update PHP</a>.', 'woocommerce-conditional-shipping-and-payments' ), '7.0.0', 'https://woocommerce.com/document/how-to-update-your-php-version/' );
			WC_CSP_Admin_Notices::add_notice( $notice, 'error' );
			return false;
		}
